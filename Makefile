...
PACKAGE_DEFS += $(call buildpackage,perl-DBIx-Class-InflateColumn-Authen-Passphrase,perl-Authen-Passphrase)
PACKAGE_DEFS += $(call buildpackage,perl-DBIx-Class-InflateColumn-Currency,perl-Data-Currency)
PACKAGE_DEFS += $(call buildpackage,perl-DBIx-Class-PassphraseColumn,perl-Authen-Passphrase perl-DBIx-Class-InflateColumn-Authen-Passphrase)
...
PACKAGE_DEFS += $(call buildpackage,perl-Locale-Codes,perl-Test-Inter)

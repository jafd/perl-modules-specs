...
PACKAGE_DEFS += $(call buildpackage,perl-HTML-Scrubber-StripScripts,)
...
PACKAGE_DEFS += $(call buildpackage,perl-Kavorka,)
...
PACKAGE_DEFS += $(call buildpackage,perl-Lingua-EN-Inflect-Phrase,perl-Lingua-EN-FindNumber perl-Lingua-EN-Number-IsOrdinal perl-Lingua-EN-Tagger)
PACKAGE_DEFS += $(call buildpackage,perl-Lingua-EN-Number-IsOrdinal,)
...
PACKAGE_DEFS += $(call buildpackage,perl-Log-Dispatch-Binlog,)
PACKAGE_DEFS += $(call buildpackage,perl-Log-Dispatch-Config,)
PACKAGE_DEFS += $(call buildpackage,perl-Log-Dispatch-Config-TestLog,)
PACKAGE_DEFS += $(call buildpackage,perl-Log-Dispatch-Configurator-Any,)
PACKAGE_DEFS += $(call buildpackage,perl-Log-Dispatch-File-Rolling,)
PACKAGE_DEFS += $(call buildpackage,perl-Log-Syslog-Constants,)
PACKAGE_DEFS += $(call buildpackage,perl-Log-Syslog-Fast,)
PACKAGE_DEFS += $(call buildpackage,perl-Math-Random-ISAAC,)
PACKAGE_DEFS += $(call buildpackage,perl-Math-Round,)
PACKAGE_DEFS += $(call buildpackage,perl-Message-Stack,perl-MooseX-Aliases)
PACKAGE_DEFS += $(call buildpackage,perl-Message-Stack-Parser,)
PACKAGE_DEFS += $(call buildpackage,perl-Method-Signatures-Simple,)
PACKAGE_DEFS += $(call buildpackage,perl-Method-Signatures-Simple-ParseKeyword,)
...
PACKAGE_DEFS += $(call buildpackage,perl-MooseX-Declare,)
...
PACKAGE_DEFS += $(call buildpackage,perl-MooseX-Method-Signatures,)
...
PACKAGE_DEFS += $(call buildpackage,perl-Parse-Method-Signatures,)
